...
import { getExerciseHistory, getPersonalRecords } from '../data/db.js';
import { formatDate } from '../utils/helpers.js';

export default function ExerciseHistory({ exercise, onClose }) {
  const history = useMemo(() => getExerciseHistory(exercise.id), [exercise.id]);
  const prs = useMemo(() => getPersonalRecords(exercise.id), [exercise.id]);
